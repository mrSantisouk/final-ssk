...
<div class="w3-display-container w3-animate-opacity">
  <img src="HKB.jpg" alt="boat" style="width:100%;min-height:350px;max-height:600px;">
...
<div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-col m7">
  <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="submit_comment.php" method="POST">
    ...
    <button type="submit" class="w3-button w3-right w3-theme">ສົ່ງ</button>
  </form>
</div>
