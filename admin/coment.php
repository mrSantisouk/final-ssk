                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ລາຍງານສະແດງຄຳຕິຊົມ</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php 
                                        ...
                                        <tr>
                                            ...
                                            <th><p><?php echo htmlentities($result->Feedback_date);?></p>
                                        
                                            </th>
                                            
                                        </tr>
                                        <tr>
                        <th ><p><?php echo htmlentities($result->Feedback_detail);?></p>
