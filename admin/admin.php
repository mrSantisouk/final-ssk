...
<body >
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ຫນ້າ admin</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="ad_admin.php" class="btn btn-sm btn-info">ເພີ່ມaddmin</a></center>
    ...
    <tbody>
    <?php
    // Replace this with the actual Admin_id you want to filter by
     $adminId = $_SESSION[':id']; // Example ID
    ...
    $query = $dbh->prepare($sql);
    $query->bindParam(':id', $adminId, PDO::PARAM_INT); // Bind the parameter
    $query->execute();
    ...
    ?>  
        <tr>
            ...
            <td><?php echo htmlentities($result->Admin_type); ?></td>
            <!-- <td><a href="historyphuphuksao.php?id=<?php echo htmlentities($result->id); ?>" class="btn btn-secondary btn-sm">ກວດຂໍ້ມູນ</a></td> -->
        </tr>
    <?php
            $cnt++;
        }
