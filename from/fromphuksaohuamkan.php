                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ຈຳນວນຜູ້ພັກເຊົາລວມກັນ</h4>
                              ...
                              <span aria-hidden="true">&times;</span>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ລ/ດ</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ສາຍພົວພັນ</label>
                                            <textarea class="form-control" name="name" type="text" length="100" id="example-text-input" rows="1" ></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ໝາຍເຫດ</label>
                                            <textarea class="form-control" name="name" type="text" length="100" id="example-text-input" rows="1" ></textarea>
                                        </div>
                                   
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">3. ເຫດຜົນຂອງການພັກເຊົາ</label>
                                            <textarea class="form-control" name="name" type="text" length="100" id="example-text-input" rows="1" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ອາຊິບ</label>
