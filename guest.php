            ...
            <form method="post" action="register_action.php">
                ...
                <label for="u_bod" class="form-label">ວັນເດືອນປີເກີດ</label>
                   ...
                   <label for="u_father_job" class="form-label"></label>
                    ...
                    <label for="u_mother_dob" class="form-label">ສະຖານທີ່ພັກເຊົາ</label>
                    <input type="text" class="form-control" id="u_mother_phone" name="u_mother_phone" placeholder="ສະຖານທີ່" required>
                    <label for="u_mother_dob" class="form-label"></label>
                    <input type="text" class="form-control" id="u_mother_phone" name="u_mother_phone" placeholder="ຊື່" required>
                    <label for="u_mother_dob" class="form-label"></label>
                    <input type="text" class="form-control" id="u_mother_phone" name="u_mother_phone" placeholder="ເຈົ້າຂອງສະຖານທີ່" required>
                    <label for="u_mother_dob" class="form-label"></label>
                    <input type="text" class="form-control" id="u_mother_phone" name="u_mother_phone" placeholder="ເບີໂທ" required>
